...
export default function ProjectContent({ slug }: { slug: string }) {
    ...
    // Generate enhanced JSON-LD for project with comprehensive schema.org data
    const projectJsonLd = project ? {
        "@context": "https://schema.org",
        "@type": "SoftwareApplication",
        "@id": `${siteUrl}projects/${slug}#application`,
        "name": project.title,
        ...
        "operatingSystem": project.platform || "Cross-Platform",
        "author": {
            "@type": "Person",
            "@id": `${siteUrl}#person`,
            "name": "Youssef Sayed",
    ...
    return (
        <React.Fragment>
            ...
            {projectJsonLd && (
                <Script
                    id={`project-${slug}-jsonld`}
                    type="application/ld+json"
                    dangerouslySetInnerHTML={{ __html: JSON.stringify(projectJsonLd, null, 2) }}
