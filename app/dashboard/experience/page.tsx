                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2">
                            ...
                            {editingExperience ? t.editExperience : t.addExperience}
                        </DialogTitle>
                    </DialogHeader>
                    ...
                    <Tabs defaultValue="english" className="w-full">
                        ...
                        <TabsContent value="arabic" className="space-y-4 mt-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <Label htmlFor="roleAr">{t.form.roleAr}</Label>
                                    <Input
                                        id="roleAr"
                                        dir="rtl"
                                        value={formData.roleAr}
                                        onChange={(e) => setFormData(prev => ({ ...prev, roleAr: e.target.value }))}
                                        placeholder={t.form.placeholders.roleAr}
                                    />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="companyAr">{t.form.companyAr}</Label>
                                    <Input
                                        id="companyAr"
                                        dir="rtl"
                                        value={formData.companyAr}
                                        onChange={(e) => setFormData(prev => ({ ...prev, companyAr: e.target.value }))}
                                        placeholder={t.form.placeholders.companyAr}
                                    />
                                </div>
                            </div>

                            <div className="space-y-2">
                                <Label htmlFor="periodAr">{t.form.periodAr}</Label>
                                <Input
                                    id="periodAr"
                                    dir="rtl"
                                    value={formData.periodAr}
                                    onChange={(e) => setFormData(prev => ({ ...prev, periodAr: e.target.value }))}
                                    placeholder={t.form.placeholders.periodAr}
                                />
                            </div>
                    ...
                    <DialogFooter className="mt-6">
                        ...
                        <Button 
                            onClick={handleSave} 
                            disabled={isSaving || !formData.role || !formData.company || !formData.period || !formData.description}
                            className="gap-2"
                        >
                            {isSaving ? (
                                <>
